...
func (pe *PiError) Code() int           { return pe.code }
func (pe *PiError) Message() string     { return pe.message }
func (pe *PiError) CodeMessage() string { return pe.codeMessage }
func (pe *PiError) InnerError() error   { return pe.innerError }
